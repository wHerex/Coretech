...
export declare class NbAlertComponent {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NbAlertComponent, "nb-alert", never, { "size": "size"; "status": "status"; "accent": "accent"; "outline": "outline"; "closable": "closable"; }, { "close": "close"; }, never, ["*"]>;
}
