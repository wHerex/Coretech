...
export declare class NbSelectComponent implements OnChanges, AfterViewInit, AfterContentInit, OnDestroy, ControlValueAccessor, NbFormFieldControl {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NbSelectComponent, "nb-select", never, { "size": "size"; "status": "status"; "shape": "shape"; "appearance": "appearance"; "placeholder": "placeholder"; "optionsOverlayOffset": "optionsOverlayOffset"; "scrollStrategy": "scrollStrategy"; "outline": "outline"; "filled": "filled"; "hero": "hero"; "disabled": "disabled"; "fullWidth": "fullWidth"; "compareWith": "compareWith"; "selected": "selected"; "multiple": "multiple"; "optionsListClass": "optionsListClass"; "optionsPanelClass": "optionsPanelClass"; }, { "selectedChange": "selectedChange"; }, ["customLabel", "options"], ["nb-select-label", "nb-option, nb-option-group"]>;
}
