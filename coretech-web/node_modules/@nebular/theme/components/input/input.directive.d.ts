...
export declare class NbInputDirective implements DoCheck, OnChanges, OnInit, AfterViewInit, OnDestroy, NbFormFieldControl {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<NbInputDirective, "input[nbInput],textarea[nbInput]", never, { "fieldSize": "fieldSize"; "status": "status"; "shape": "shape"; "fullWidth": "fullWidth"; }, {}, never>;
}
