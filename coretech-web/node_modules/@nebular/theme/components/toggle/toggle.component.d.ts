...
export declare class NbToggleComponent implements OnInit, AfterViewInit, OnDestroy, ControlValueAccessor {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NbToggleComponent, "nb-toggle", never, { "status": "status"; "labelPosition": "labelPosition"; "checked": "checked"; "disabled": "disabled"; }, { "checkedChange": "checkedChange"; }, never, ["*"]>;
}
