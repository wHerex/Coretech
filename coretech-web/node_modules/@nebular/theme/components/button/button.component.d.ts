...
export declare class NbButtonComponent extends NbButton implements AfterViewInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NbButtonComponent, "button[nbButton],a[nbButton],input[type=\"button\"][nbButton],input[type=\"submit\"][nbButton]", never, { "hero": "hero"; }, {}, never, ["*"]>;
}
