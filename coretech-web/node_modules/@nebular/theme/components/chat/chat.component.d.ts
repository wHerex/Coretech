...
export declare class NbChatComponent implements OnChanges, AfterContentInit, AfterViewInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NbChatComponent, "nb-chat", never, { "status": "status"; "noMessagesPlaceholder": "noMessagesPlaceholder"; "scrollBottom": "scrollBottom"; "title": "title"; "size": "size"; }, {}, ["chatForm", "messages"], ["nb-chat-message", "nb-chat-form"]>;
}
