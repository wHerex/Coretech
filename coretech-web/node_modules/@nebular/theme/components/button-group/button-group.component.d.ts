...
import { NbButtonToggleAppearance } from './button-toggle.directive';
/**
...
export declare class NbButtonGroupComponent implements OnChanges, AfterContentInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<NbButtonGroupComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NbButtonGroupComponent, "nb-button-group", never, { "size": "size"; "status": "status"; "shape": "shape"; "appearance": "appearance"; "disabled": "disabled"; "multiple": "multiple"; "filled": "filled"; "outline": "outline"; "ghost": "ghost"; }, {}, ["buttons"], ["*"]>;
}
